(function() {
    ...
    let lw = function(script_path) {
        let primary = "http://localhost:8909/static/js/adWrapper.js";
        let secondary = "http://localhost:8909/static/js/adWrapper.js";
    ...
    const sc = [];
    sc.push({
        "script_path": "http://localhost:8909/static/js/adWrapper.js",
        "pct": 100
    })
    if (fgp("lngtd_version")) {
        let scriptPath = `bookrags/${fgp("lngtd_version")}.js`;
        lw(scriptPath);
    } else {
