...
/* harmony import */ var _targeting_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./targeting.js */ "./src/targeting.js");
 ...
 */
const addBidResponse = (0,_hook_js__WEBPACK_IMPORTED_MODULE_11__.hook)('sync', function (adUnitCode, bid, reject) {
  if (!isValidPrice(bid)) {
...
function auctionCallbacks(auctionDone, auctionInstance) {
  ...
  function adapterDone() {
    ...
    if (auctionOptionsConfig && !(0,_utils_js__WEBPACK_IMPORTED_MODULE_5__.isEmpty)(auctionOptionsConfig)) {
      ...
      if (secondaryBidders && !bidderRequests.every(bidder => (0,_polyfill_js__WEBPACK_IMPORTED_MODULE_15__.includes)(secondaryBidders, bidder.bidderCode))) {
        bidderRequests = bidderRequests.filter(request => !(0,_polyfill_js__WEBPACK_IMPORTED_MODULE_15__.includes)(secondaryBidders, request.bidderCode));
      }
    }
...
const callPrebidCache = (0,_hook_js__WEBPACK_IMPORTED_MODULE_11__.hook)('async', function (auctionInstance, bidResponse, afterBidAdded, videoMediaType) {
  if (true) {
    (0,_videoCache_js__WEBPACK_IMPORTED_MODULE_17__.batchAndStore)(auctionInstance, bidResponse, afterBidAdded);
  }
}, 'callPrebidCache');
...
function setupBidTargeting(bidObject) {
  let keyValues;
  const cpmCheck = _bidderSettings_js__WEBPACK_IMPORTED_MODULE_20__.bidderSettings.get(bidObject.bidderCode, 'allowZeroCpmBids') === true ? bidObject.cpm >= 0 : bidObject.cpm > 0;
...
function getStandardBidderSettings(mediaType, bidderCode) {
  const standardSettings = Object.assign({}, _bidderSettings_js__WEBPACK_IMPORTED_MODULE_20__.bidderSettings.settingsFor(null));
  ...
  if ( true && mediaType === 'video') {
    ...
    [_constants_js__WEBPACK_IMPORTED_MODULE_2__.TARGETING_KEYS.UUID, _constants_js__WEBPACK_IMPORTED_MODULE_2__.TARGETING_KEYS.CACHE_ID].forEach(targetingKeyVal => {
      if (typeof (0,_polyfill_js__WEBPACK_IMPORTED_MODULE_15__.find)(adserverTargeting, kvPair => kvPair.key === targetingKeyVal) === 'undefined') {
        adserverTargeting.push(createKeyVal(targetingKeyVal, 'videoCacheKey'));
      }
    });

    // Adding hb_cache_host
    if (_config_js__WEBPACK_IMPORTED_MODULE_10__.config.getConfig('cache.url') && (!bidderCode || _bidderSettings_js__WEBPACK_IMPORTED_MODULE_20__.bidderSettings.get(bidderCode, 'sendStandardTargeting') !== false)) {
...
function getKeyValueTargetingPairs(bidderCode, custBidObj) {
  ...
  if (bidderCode && _bidderSettings_js__WEBPACK_IMPORTED_MODULE_20__.bidderSettings.getOwn(bidderCode, _constants_js__WEBPACK_IMPORTED_MODULE_2__.JSON_MAPPING.ADSERVER_TARGETING)) {
...
function adjustBids(bid) {
  let bidPriceAdjusted = (0,_utils_cpm_js__WEBPACK_IMPORTED_MODULE_21__.adjustCpm)(bid.cpm, bid);
...
/* harmony export */ });
/* unused harmony exports PROCESSOR_DIALECTS, PBS, processorRegistry, registerOrtbProcessor */
...
/* unused harmony exports syncOrtb2, adUnitSetupChecks, checkAdUnitSetup, startAuction, executeCallbacks */
/* harmony import */ var _prebidGlobal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./prebidGlobal.js */ "./src/prebidGlobal.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils.js */ "./src/utils.js");
...
/* harmony import */ var _secureCreatives_js__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./secureCreatives.js */ "./src/secureCreatives.js");
...
/* harmony import */ var _bidfactory_js__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./bidfactory.js */ "./src/bidfactory.js");
...
/* harmony import */ var _utils_promise_js__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./utils/promise.js */ "./src/utils/promise.js");
...
pbjsInstance.version = "v9.26.0-pre";
(0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logInfo)("Prebid.js v9.26.0-pre loaded");
...
pbjsInstance.requestBids = function () {
  const delegate = (0,_hook_js__WEBPACK_IMPORTED_MODULE_11__.hook)('async', function () {
    ...
    if (adUnitCodes && adUnitCodes.length) {
      ...
      adUnits = adUnits.filter(unit => (0,_polyfill_js__WEBPACK_IMPORTED_MODULE_18__.includes)(adUnitCodes, unit.code));
    } else {
    ...
    const ortb2Fragments = {
      ...
      bidder: Object.fromEntries(Object.entries(_config_js__WEBPACK_IMPORTED_MODULE_17__.config.getBidderConfig()).map(_ref2 => {
        let [bidder, cfg] = _ref2;
    ...
    return (0,_fpd_enrichment_js__WEBPACK_IMPORTED_MODULE_19__.enrichFPD)(_utils_promise_js__WEBPACK_IMPORTED_MODULE_20__.GreedyPromise.resolve(ortb2Fragments.global)).then(global => {
  ...
  return (0,_hook_js__WEBPACK_IMPORTED_MODULE_11__.wrapHook)(delegate, function requestBids() {
    ...
    req.defer = (0,_utils_promise_js__WEBPACK_IMPORTED_MODULE_20__.defer)({
...
const startAuction = (0,_hook_js__WEBPACK_IMPORTED_MODULE_11__.hook)('async', function () {
  ...
  adUnits.forEach(adUnit => {
    ...
    bidders.forEach(bidder => {
      ...
      const bidderEligible = adUnitMediaTypes.some(type => (0,_polyfill_js__WEBPACK_IMPORTED_MODULE_18__.includes)(bidderMediaTypes, type));
      if (!bidderEligible) {
...
pbjsInstance.registerBidAdapter = function (bidderAdaptor, bidderCode) {
  ...
  try {
    _adapterManager_js__WEBPACK_IMPORTED_MODULE_22__["default"].registerBidAdapter(bidderAdaptor(), bidderCode);
  } catch (e) {
...
pbjsInstance.createBid = function (statusCode) {
  ...
  return (0,_bidfactory_js__WEBPACK_IMPORTED_MODULE_24__.createBid)(statusCode);
};
...
if (true) {
   ...
   */
  pbjsInstance.markWinningBidAsUsed = function (_ref4) {
    let {
      adId,
      adUnitCode,
      analytics = false
...
pbjsInstance.que.push(() => (0,_secureCreatives_js__WEBPACK_IMPORTED_MODULE_25__.listenMessagesFromCreative)());
 ...
 */
pbjsInstance.triggerBilling = _ref5 => {
  let {
    adId,
    adUnitCode
  } = _ref5;
...
function newTargeting(auctionManager) {
  ...
  function getBidderTargeting(bids) {
    ...
    const enableSendAllBids = _config_js__WEBPACK_IMPORTED_MODULE_5__.config.getConfig('enableSendAllBids');
...
/* harmony export */ });
/* unused harmony exports getPrebidInternal, getBidIdParameter, sizeTupleToSizeString, parseGPTSingleSizeArray, parseGPTSingleSizeArrayToRtbSize, getWindowLocation, canAccessWindowTop, hasConsoleLogger, debugTurnedOn, isA, _each, contains, _map, waitForElementToLoad, createTrackPixelIframeHtml, getBidRequest, getValue, isSafeFrameWindow, getSafeframeGeometry, replaceAuctionPrice, replaceClickThrough, getDomLoadingDuration, compareCodeAndSlot, cleanObj, parseQS, formatQS, deepEqual, safeJSONParse, safeJSONEncode, getUnixTimestampFromNow, convertObjectToArray, hasNonSerializableProperty, setOnAny, extractDomainFromHost, triggerNurlWithCpm */
/* harmony import */ var _config_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./config.js */ "./src/config.js");
...
/******/ __webpack_require__ => { // webpackRuntimeModules
/******/ var __webpack_exec__ = (moduleId) => (__webpack_require__(__webpack_require__.s = moduleId))
/******/ __webpack_require__.O(0, ["chunk-core","creative-renderer-display"], () => (__webpack_exec__("./modules/medscapeBidAdapter.js")));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ }
]);

"use strict";
(self["pbjsChunk"] = self["pbjsChunk"] || []).push([["pulsepointBidAdapter"],{
...
/* harmony import */ var _src_utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/utils.js */ "./src/utils.js");
/* harmony import */ var _src_adapters_bidderFactory_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../src/adapters/bidderFactory.js */ "./src/adapters/bidderFactory.js");
...
const converter = (0,_libraries_ortbConverter_converter_js__WEBPACK_IMPORTED_MODULE_0__.ortbConverter)({
  ...
  imp(buildImp, bidRequest, context) {
    ...
    // deals
    if (bidRequest.params.deals && (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_1__.isArray)(bidRequest.params.deals)) {
      imp.pmp = {
        private_auction: 0,
...
(0,_src_adapters_bidderFactory_js__WEBPACK_IMPORTED_MODULE_2__.registerBidder)(spec);
(0,_src_prebidGlobal_js__WEBPACK_IMPORTED_MODULE_3__.registerModule)('pulsepointBidAdapter');
